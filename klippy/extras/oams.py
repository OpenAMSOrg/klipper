...
""" 
    ...
    def __init__(self, config) -> None:
        ...
        self.bldc_reset_pin = PrinterOutputPin(config, bldc_reset_pin_name, False, False, False)
    ...
    def bldc_run(self, value, forward=True, reset=False):
